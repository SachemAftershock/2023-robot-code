...
public class CubeMidStartingRight extends SequentialCommandGroup{
    ...
    public CubeMidStartingRight(DriveSubsystem drive, ElevatorSubsystem elevator, ArmSubsystem arm, IntakeSubsystem intake) {
