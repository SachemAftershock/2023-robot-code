...
public class CubeMidStartingLeft extends SequentialCommandGroup{
    ...
    public CubeMidStartingLeft(DriveSubsystem drive, ElevatorSubsystem elevator, ArmSubsystem arm, IntakeSubsystem intake) {
