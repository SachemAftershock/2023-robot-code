...
public class CubeLowOnly extends SequentialCommandGroup{
    ...
    public CubeLowOnly(DriveSubsystem drive, ElevatorSubsystem elevator, ArmSubsystem arm, IntakeSubsystem intake) {
