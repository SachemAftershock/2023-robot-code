...
public class CubeHighStartingLeft extends SequentialCommandGroup{
    ...
    public CubeHighStartingLeft(DriveSubsystem drive, ElevatorSubsystem elevator, ArmSubsystem arm, IntakeSubsystem intake) {
        ...
        addCommands(
            ...
            new LinearDriveCommand(drive, -0.5, CardinalDirection.eY),
