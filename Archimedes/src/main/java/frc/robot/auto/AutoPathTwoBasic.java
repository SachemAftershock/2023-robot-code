...
public class AutoPathTwoBasic extends SequentialCommandGroup{
    ...
    public AutoPathTwoBasic(DriveSubsystem drive, ElevatorSubsystem elevator, ArmSubsystem arm, IntakeSubsystem intake) {
