...
public class AutoPathTwoNoCharge extends SequentialCommandGroup {
    ...
    Trajectory pathToCone = TrajectoryGenerator.generateTrajectory(
        new Pose2d(1.9, 4.89, new Rotation2d()), List.of(
            // new Translation2d(1.9 - startX, 4.89 - startY),
    ...
    public AutoPathTwoNoCharge(
        ...
        addCommands(
            ...
            FollowTrajectoryCommandFactory.generateCommand(mDrive, mNewPathToCone), new RotateDriveCommand(mDrive, 180),

            // Sequence for picking up cone and stowing
            new InstantCommand(() -> RobotContainer.setIsCone()), new IngestConeCommand(mIntake),
