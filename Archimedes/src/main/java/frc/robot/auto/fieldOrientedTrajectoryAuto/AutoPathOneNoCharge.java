...
public class AutoPathOneNoCharge extends SequentialCommandGroup {
    ...
    Trajectory pathToCone = TrajectoryGenerator.generateTrajectory(
        new Pose2d(new Translation2d(1.9, .45), new Rotation2d(1 / 2 * Math.PI)),
        List.of(new Translation2d(1.9, 0.45), new Translation2d(4.98, 0.92)), new Pose2d(6.45, 2.11, new Rotation2d()),
        config
    );
    ...
    Trajectory pathToChargeStation = TrajectoryGenerator.generateTrajectory(
        new Pose2d(), List.of(new Translation2d(1.9, 1.62), new Translation2d(2.39, 2.37)),
        new Pose2d(3.92, 2.39, new Rotation2d()), config
    );

    public AutoPathOneNoCharge(
