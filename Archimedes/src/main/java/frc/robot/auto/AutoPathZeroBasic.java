...
public class AutoPathZeroBasic extends SequentialCommandGroup{
    ...
    public AutoPathZeroBasic(DriveSubsystem drive, ElevatorSubsystem elevator, ArmSubsystem arm, IntakeSubsystem intake) {
