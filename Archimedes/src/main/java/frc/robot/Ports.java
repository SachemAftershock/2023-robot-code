...
public class Ports {
    ...
    public static final class RioPortConstants {
        ...
        public static enum DioPorts {
            ...
            eDioPort9, eDioPort10, eDioPort11, eDioPort12, eDioPort13, eDioPort14, eDioPort15, eDioPort16, eDioPort17,
            eDioPort18, eDioPort19;
        ...
        public static enum CanAddresses {
            ...
            eCanAddress7, eCanAddress8, eCanAddress9, eCanAddress10, eCanAddress11, eCanAddress12, eCanAddress13,
            eCanAddress14, eCanAddress15, eCanAddress16, eCanAddress17, eCanAddress18;
    ...
    public static final class IntakePorts {
        ...
        public static final int kIntakeLidarId = DioPorts.eDioPort3.get();
    }
    ...
    public static final class ArmPorts {
        public static final int kLeftArmMotorId = CanAddresses.eCanAddress3.get();
        public static final int kRightArmMotorId = CanAddresses.eCanAddress6.get();
        ...
        public static final int kHookEncoderId = DioPorts.eDioPort1.get();
    }
}
