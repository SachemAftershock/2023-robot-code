...
public class ButtonBoxLedInfo {
    ...
    public enum LedPosition {
        // WAYPOINTS
        eDriveTo1(5), eDriveTo2(23), eDriveTo3(7), eDriveTo4(4), eDriveTo5(17), eDriveTo6(15), eDriveTo7(6),
        eDriveTo8(18), eDriveTo9(3), eHumanPlayerLeft(14), eHumanPlayerRight(25), eCancel(16),
    ...
    public enum ButtonPosition {
        // WAYPOINTS
        eDriveTo1, eDriveTo2, eDriveTo3, eDriveTo4, eDriveTo5, eDriveTo6, eDriveTo7, eDriveTo8, eDriveTo9, eCancel,
        eHumanPlayerLeft, eHumanPlayerRight,
