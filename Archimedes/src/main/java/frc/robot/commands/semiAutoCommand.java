...
public class semiAutoCommand extends CommandBase{
    ...
    private double distanceFromBuffer = 0.41 + .1875; //The distance between the apriltag and the channel, measured from the cone scoring area + a buffer number
    ...
    public semiAutoCommand(Pose2d startingPoint, double xPose, double yPose, DriveSubsystem drive, int right){
        ...
        //If right is one, then the robot will shift to the right of the selected apriltag
        //If right is -one, then the robot will shift to the left of the selected apriltag
        ...
        Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
            ...
            new Pose2d(xPose - channelMidpoint - distanceFromBuffer, yPose, new Rotation2d(Math.PI)), 
            config
        );
        Trajectory trajectory2 = TrajectoryGenerator.generateTrajectory(
            ...
            new Pose2d(xPose - distanceFromBuffer, yPose, new Rotation2d()), 
            config
        );
