...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    mButtonBox.ingestIntake().onTrue(
        RobotContainer.isCone() ? new IngestConeCommand(mIntakeSubsystem) : new IngestCubeCommand(mIntakeSubsystem))
        .onFalse(new StopIntakeCommand(mIntakeSubsystem));

    mButtonBox.ejectIntake().onTrue(
        RobotContainer.isCone() ? new OutputConeCommand(mIntakeSubsystem) : new OutputCubeCommand(mIntakeSubsystem))
        .onFalse(new StopIntakeCommand(mIntakeSubsystem));
