...
public class ElevatorSubsystem extends AftershockSubsystem {
    ...
    public void periodic() {
        ...
        if (counter > 100) {
            ...
            // System.out.println(
            // "ERROR ---------- ELEVATOR ROPE WOUND BACKWARDS ----------" + mPid.getError()
            // + " " + prevDelta
            // );
            // // mCurrentState = null;
            // // mDesiredState = null;
            ...
            if (Math.abs(speed) > 0.0 && Math.abs(distance - prevDistance) < kEpsilon) {
                System.out.println(
                    "ERROR ---------- ELEVATOR ROPE WOUND BACKWARDS ---------- distance " + distance + "  "
                        + prevDistance
                );
                // mCurrentState = null;
                // mDesiredState = null;
        ...
        // System.out.println("Setpoint --> " + mSetpoint + " Current --> " + current +
        // " Motor Speed --> " + output);
